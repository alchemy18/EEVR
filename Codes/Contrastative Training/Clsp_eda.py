        ...
        for participant_id in pi:
            ...
            for seed in random_seed:
                ...
                for label_id in range(3):
                    ...
                    if label_id == 2:
                        eda_df1 = balanced_df(eda_df) # balanaced df for arousal
                    else:
                        eda_df1  = eda_df
                    ...
                    fet = relevant_features # handcrafted features

                    print(f"Participant id {participant_id}")
                    train_data = eda_df1[eda_df1['Participant ID'] != participant_id] 
                    train_data = train_data.reset_index(drop=True)
                    test_data = eda_df1[eda_df1['Participant ID'] == participant_id]
                    ...
                    params = [
                            ...
                            {"params": model.eda_encoder.parameters(), "lr": 1e-3},
                    ...
                    model_path = f"best_eda_{label_id}_{seed}_{participant_id}.pt"
                    for epoch in range(epochs):
                        print(f"Epoch: {epoch + 1}")
                        model.train()
                        model.eda_train(learning_rate, beta1, beta2 , epsilon, train_dataloader)
                        loss_meter = AvgMeter()
